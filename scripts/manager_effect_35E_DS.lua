...
-- Changed EffectManager35E.parseEffectComp to EffectManager.parseEffectCompSimple
...
function getEffectsBonus(rActor, aEffectType, bModOnly, aFilter, rFilterActor, bTargetedOnly)
    ...
    for k, v in pairs(aEffectType) do
        ...
        local effbonusbytype, nEffectSubCount = EffectManager35EDS.getEffectsBonusByType(rActor, v, true, aFilter,
...
function hasEffectCondition(rActor, sEffect, rTarget)
    return EffectManager35EDS.hasEffect(rActor, sEffect, rTarget, false, true);
end
